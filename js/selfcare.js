  ...
  exercises: {
    ...
    '首〜肩': {
      ...
      tension: {
        name: '首〜肩の伸長ケア',
        target: '胸鎖乳突筋・斜角筋',
        description: '首から肩が上下に伸長されています。安定させるエクササイズが効果的です。',
        evidence: '肩すくめ＋脱力法は筋緊張の軽減に効果的（筋弛緩法のエビデンス）',
        steps: [
          '椅子に座り、両手を膝の上に置きます',
          '伸長している側の肩をゆっくり上げ、耳に近づけます',
          '5秒キープしてストンと力を抜きます',
          '10回繰り返します',
    ...
    '肩〜腕': {
      ...
      tension: {
        name: '肩〜腕の伸長ケア',
        target: '肩関節周囲筋・前鋸筋',
        description: '肩から腕が上下に伸長されています。座ったまま肩甲骨を動かして安定させます。',
    ...
    '前腕〜手首': {
      contraction: {
        name: '前腕〜手首の収縮ケア',
        target: '前腕屈筋群',
        description: '前腕から手首にかけて収縮しています。手首のストレッチが効果的です。',
        evidence: '手首ストレッチは腱鞘炎・手根管症候群の予防に効果的（職業性疾患予防ガイドライン）',
        steps: [
          '収縮している側の腕をまっすぐ前に伸ばします',
      ...
      tension: {
        name: '前腕〜手首の伸長ケア',
        target: '前腕伸筋群・回外筋',
        description: '前腕が上下に伸長されています。握力トレーニングで安定させます。',
    ...
    '股関節〜太もも': {
      contraction: {
        name: '股関節〜太ももの収縮ケア',
        target: '腸腰筋・中殿筋',
        description: '股関節から太ももにかけて収縮があります。椅子に座ったまま股関節を伸ばします。',
      ...
      tension: {
        name: '股関節〜太ももの伸長ケア',
        target: '内転筋・大腿筋膜張筋',
        description: '股関節が上下に伸長されています。骨盤の安定化エクササイズが効果的です。',
    ...
    '太もも〜膝': {
      contraction: {
        ...
        description: '太ももから膝にかけて収縮しています。太もものストレッチが重要です。',
      ...
      tension: {
        name: '太もも〜膝の伸長ケア',
        target: '大腿直筋・腸脛靭帯',
        description: '太ももが上下に伸長されています。うつ伏せで太もも前面を伸ばします。',
    ...
    'すね〜足首': {
      contraction: {
        name: 'すね〜足首の収縮ケア',
        target: '腓腹筋・ヒラメ筋',
        description: 'すねから足首にかけて収縮しています。座ったままタオルでふくらはぎを伸ばします。',
      ...
      tension: {
        name: 'すね〜足首の伸長ケア',
        target: '前脛骨筋・足底筋群',
        description: 'すねから足首が伸長されています。足首の安定化エクササイズを行います。',
