...
const SelfcareDatabase = {
  exercises: {
    ...
    '前腕〜手首': {
      contraction: {
        name: '前腕〜手首の収縮ケア（手首伸展ストレッチ）',
        target: '前腕屈筋群・橈側手根屈筋・尺側手根屈筋',
        description: '前腕から手首にかけて屈筋群が収縮しています。反対の手で手首を反らして前腕内側を伸ばすストレッチが効果的です。',
        evidence: '手首伸展ストレッチは前腕屈筋群の柔軟性改善・腱鞘炎予防に効果的（職業性疾患予防ガイドライン）',
        steps: [
          '片方の腕をまっすぐ前に伸ばし、手のひらを正面に向けます',
          '反対の手で指先をつかみ、手前にゆっくり引きます',
          '前腕の内側に伸びを感じたら20秒キープ',
          'ゆっくり戻して3回繰り返します',
          '反対側も同様に行います'
        ],
        ...
        caution: '手首を強く反らしすぎないようにしてください。痛みが出たら引く力を弱めてください。',
        illustration: 'wristStretch'
      }
    },
    '腹部前面': {
      contraction: {
        name: '腹部前面の収縮ケア（マッケンジー体操）',
        target: '腹直筋・腸腰筋上部',
  ...
  _getTip(illustrationKey) {
    const tips = {
      ...
      wristStretch: '肘をしっかり伸ばした状態で行うのがポイント。デスクワークの合間に行うと効果的です。',
